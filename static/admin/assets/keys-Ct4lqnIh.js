import { u as L } from "./keys-C1zTkIiK.js";
import { B } from "./Button-BTod08TO.js";
import { b as ee, U as oe, V as $, F as S, f as P, h as x, g as K, W as te, e as re, d as M, j as u, X as ne, Y as se, Z as le, k as ae, l as U, _ as ie, m as ce, a as N, $ as de, a0 as ue, a1 as ve, a2 as me, a3 as fe, a4 as ge, J as k, r as T, w as pe, n as E, p as R, q as b, y as z, s as l, v as _, x as W, B as H, A as F, o as _e, z as be, D as he } from "./index-05ypFx4P.js";
import { u as V } from "./use-message-ATPVOnVB.js";
import { _ as Ce } from "./FormItem-QsNyBlj1.js";
import { _ as ye } from "./Input-DWI3RPho.js";
import { _ as xe, a as Ie } from "./InputNumber-8BaSFOJn.js";
import { a as we, r as ke } from "./use-form-item-C0_shOgu.js";
import { a as ze, N as $e } from "./DataTable-BJIWqNGu.js";
...
`, [x("border", `
 ...
 `, [re("& +", [x("content", { marginTop: "9px" })])]), x("content", { transition: "color .3s var(--n-bezier)", fontSize: "var(--n-font-size)" })]), x("icon", { transition: "color .3s var(--n-bezier)" })]), Ae = Object.assign(Object.assign({}, U.props), { title: String, showIcon: { type: Boolean, default: true }, type: { type: String, default: "default" }, bordered: { type: Boolean, default: true }, closable: Boolean, onClose: Function, onAfterLeave: Function, onAfterHide: Function }), Be = M({ name: "Alert", inheritAttrs: false, props: Ae, slots: Object, setup(d) {
  ...
  return (m, n) => {
    ...
    return E(), R(s, { show: d.show, title: l(p), preset: "card", style: { width: "480px" }, "onUpdate:show": n[6] || (n[6] = (v) => f("update:show", v)) }, { footer: b(() => [z("div", Ne, [_(e, { onClick: n[5] || (n[5] = (v) => f("update:show", false)) }, { default: b(() => [...n[7] || (n[7] = [H("Cancel", -1)])]), _: 1 }), _(e, { type: "primary", loading: l(C), onClick: y }, { default: b(() => [H(F(l(h) ? "Save" : "Create"), 1)]), _: 1 }, 8, ["loading"])])]), default: b(() => [z("div", Ee, [l(h) ? (E(), R(t, { key: 0, label: "Key" }, { default: b(() => [_(c, { value: d.existing.api_key, readonly: "" }, null, 8, ["value"])]), _: 1 })) : W("", true), _(t, { label: "Name", required: "" }, { default: b(() => [_(c, { value: l(o).name, "onUpdate:value": n[0] || (n[0] = (v) => l(o).name = v), placeholder: "e.g. Production App" }, null, 8, ["value"])]), _: 1 }), l(h) ? W("", true) : (E(), R(t, { key: 1, label: "User ID", required: "" }, { default: b(() => [_(c, { value: l(o).user_id, "onUpdate:value": n[1] || (n[1] = (v) => l(o).user_id = v), placeholder: "e.g. user_001" }, null, 8, ["value"])]), _: 1 })), z("div", Re, [_(t, { label: "Rate Limit (rpm)", class: "flex-1" }, { default: b(() => [_(I, { value: l(o).rate_limit, "onUpdate:value": n[2] || (n[2] = (v) => l(o).rate_limit = v), min: 0, class: "w-full" }, null, 8, ["value"])]), _: 1 }), _(t, { label: "Monthly Budget ($)", class: "flex-1" }, { default: b(() => [_(I, { value: l(o).monthly_budget, "onUpdate:value": n[3] || (n[3] = (v) => l(o).monthly_budget = v), min: 0, precision: 2, placeholder: "unlimited", class: "w-full" }, null, 8, ["value"])]), _: 1 })]), _(t, { label: "Service Tier" }, { default: b(() => [_(c, { value: l(o).service_tier, "onUpdate:value": n[4] || (n[4] = (v) => l(o).service_tier = v) }, null, 8, ["value"])]), _: 1 })])]), _: 1 }, 8, ["show", "title"]);
  };
} }), Ke = { class: "flex items-center justify-between mb-6" }, We = { class: "flex items-center gap-3 mt-2" }, Me = { class: "font-mono text-sm" }, Ye = M({ __name: "keys", setup(d) {
  ...
  return _e(o), (e, s) => {
    const v = ze;
    return E(), be("div", null, [z("div", Ke, [s[5] || (s[5] = z("h1", { class: "text-xl font-semibold text-slate-100" }, "API Keys", -1)), _(l(B), { type: "primary", onClick: C }, { icon: b(() => [...s[3] || (s[3] = [z("span", { class: "i-carbon-add" }, null, -1)])]), default: b(() => [s[4] || (s[4] = H(" Create Key ", -1))]), _: 1 })]), l(p) ? (E(), R(l(Be), { key: 0, type: "success", class: "mb-4", title: "API Key Created \u2014 save this key now, it will not be shown again", closable: "", onClose: s[1] || (s[1] = (A) => p.value = null) }, { default: b(() => [z("div", We, [z("span", Me, F(l(p)), 1), _(l(B), { size: "small", onClick: s[0] || (s[0] = (A) => c(l(p))) }, { icon: b(() => [...s[6] || (s[6] = [z("span", { class: "i-carbon-copy" }, null, -1)])]), default: b(() => [s[7] || (s[7] = H(" Copy ", -1))]), _: 1 })])]), _: 1 })) : W("", true), _(v, { columns: I, data: l(f), loading: l(i), pagination: { pageSize: 20 }, size: "small" }, null, 8, ["data", "loading"]), _(He, { show: l(g), "onUpdate:show": s[2] || (s[2] = (A) => he(g) ? g.value = A : null), existing: l(h), onSaved: n }, null, 8, ["show", "existing"])]);
  };
} });
export {
  Ye as default
