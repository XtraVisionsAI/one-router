import { f as a, e as d, h as C, d as N, j as L, k as O, ad as $, g as F, l as V, ae as K, af as M, ag as R, r as P, u as A, ah as W, ai as q, n as z, z as G, y as w, v, q as I, aj as D, s as y, E as T, B as U, D as H, C as J, ak as Q } from "./index-DicalUKt.js";
import { f as X, a as Y, _ as Z } from "./FormItem-BLFgOPpX.js";
import { u as tt } from "./use-message-DGZGK5Il.js";
import { _ as et } from "./Input-VFsf8aBL.js";
...
`, [d(">", [a("input", [d("&:not(:last-child)", `
 ...
 `)])])])])])]), rt = {}, nt = N({ name: "InputGroup", props: rt, setup(o) {
  ...
  return L("div", { class: `${o}-input-group` }, this.$slots);
} }), it = a("form", [F("inline", `
 width: 100%;
 display: inline-flex;
...
const st = Object.assign(Object.assign({}, V.props), { inline: Boolean, labelWidth: [Number, String], labelAlign: String, labelPlacement: { type: String, default: "top" }, model: { type: Object, default: () => {
  ...
  const { mergedClsPrefix: o } = this;
  return L("form", { class: [`${o}-form`, this.inline && `${o}-form--inline`], onSubmit: this.onSubmit }, this.$slots);
  ...
  return (e, t) => {
    const i = et, f = U, B = nt, k = Z, b = dt;
    return z(), G("div", lt, [t[3] || (t[3] = w("div", { class: "mb-6 text-center" }, [w("span", { class: "text-indigo-400 font-semibold text-xl" }, "one-router"), w("span", { class: "ml-2 text-sm text-slate-500 bg-slate-700 px-2 py-0.5 rounded" }, "admin")], -1)), t[4] || (t[4] = w("p", { class: "text-slate-400 text-sm text-center mb-6" }, " Enter your master or ephemeral API key to continue. ", -1)), v(b, { onSubmit: Q(c, ["prevent"]) }, { default: I(() => [v(k, null, { default: I(() => [v(B, null, { default: I(() => [v(i, { value: y(n), "onUpdate:value": t[0] || (t[0] = (h) => T(n) ? n.value = h : null), type: y(m) ? "text" : "password", placeholder: "sk-...", disabled: y(s), onKeydown: D(c, ["enter"]) }, null, 8, ["value", "type", "disabled"]), v(f, { onClick: t[1] || (t[1] = (h) => m.value = !y(m)) }, { icon: I(() => [w("span", { class: H(y(m) ? "i-carbon-view-off" : "i-carbon-view") }, null, 2)]), _: 1 })]), _: 1 })]), _: 1 }), v(f, { type: "primary", block: "", loading: y(s), onClick: c }, { default: I(() => [...t[2] || (t[2] = [J(" Sign in ", -1)])]), _: 1 }, 8, ["loading"])]), _: 1 })]);
  };
} });
typeof E == "function" && E(ut);
export {
  ut as default
};
