import { u as B } from "./backends-CLLt8N6j.js";
import { u as N } from "./keys-0lEPjgJp.js";
import { u as K, a as M, _ as o } from "./useApi-ViaiVG_-.js";
import { _ as r } from "./Statistic-83i-1M9O.js";
import { _ as R } from "./Spin-CKyYFK8t.js";
import { d as $, o as C, z as P, y as l, v as a, p as i, q as t, r as u, s as T, j as m } from "./index-HnuybbhN.js";
import { a as y, N as c } from "./DataTable-r4E-uZoH.js";
import "./use-form-item-DgrHZmhA.js";
import "./Button-DSNNFXd2.js";
const E = { class: "grid grid-cols-4 gap-4 mb-8" }, q = { class: "mb-8" }, F = $({ __name: "dashboard", setup(w) {
  const h = K(), k = B(), v = N(), { request: b } = M(), d = u([]), n = u([]), _ = u(""), f = u(true);
  function g(e) {
