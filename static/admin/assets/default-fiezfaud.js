import { d as k, j as a, ax as G, e as b, f as g, g as y, h as p, J as L, a1 as Te, aU as O, a5 as Ee, i as E, a as C, aq as X, af as te, T as Fe, ag as U, b3 as Y, aa as Oe, r as F, aO as Ke, k as Le, l as ge, Y as se, m as Be, az as je, a2 as $e, S as M, bj as Ve, t as ue, ai as De, z as Ue, y as H, v as Z, s as ve, A as Ge, q as me, B as qe, u as We, ah as Je, bi as Ye, n as Ze, C as Qe } from "./index-DicalUKt.js";
import { m as Xe, n as eo, j as oo, k as Q } from "./Dropdown-DwMgs0HP.js";
import { u as he } from "./use-merged-state-CkMZ2DWG.js";
import { u as to } from "./use-compitable-Cxdw_G8M.js";
...
const no = k({ name: "ChevronDownFilled", render() {
 ...
 `)]), L("disabled", [L("selected, child-active", [b("&:focus-within", fe)]), y("selected", [T(null, [p("icon", "color: var(--n-item-icon-color-active-hover-horizontal);"), g("menu-item-content-header", `
 color: var(--n-item-text-color-active-hover-horizontal);
 `, [b("a", "color: var(--n-item-text-color-active-hover-horizontal);"), p("extra", "color: var(--n-item-text-color-active-hover-horizontal);")])])]), y("child-active", [T(null, [p("icon", "color: var(--n-item-icon-color-child-active-hover-horizontal);"), g("menu-item-content-header", `
 color: var(--n-item-text-color-child-active-hover-horizontal);
 `, [b("a", "color: var(--n-item-text-color-child-active-hover-horizontal);"), p("extra", "color: var(--n-item-text-color-child-active-hover-horizontal);")])])]), T("border-bottom: 2px solid var(--n-border-color-horizontal);", fe)]), g("menu-item-content-header", [b("a", "color: var(--n-item-text-color-horizontal);")])])]), L("responsive", [g("menu-item-content-header", `
 overflow: hidden;
 ...
 `)]), L("disabled", [L("selected, child-active", [b("&:focus-within", pe)]), y("selected", [T(null, [p("arrow", "color: var(--n-arrow-color-active-hover);"), p("icon", "color: var(--n-item-icon-color-active-hover);"), g("menu-item-content-header", `
 color: var(--n-item-text-color-active-hover);
 `, [b("a", "color: var(--n-item-text-color-active-hover);"), p("extra", "color: var(--n-item-text-color-active-hover);")])])]), y("child-active", [T(null, [p("arrow", "color: var(--n-arrow-color-child-active-hover);"), p("icon", "color: var(--n-item-icon-color-child-active-hover);"), g("menu-item-content-header", `
 color: var(--n-item-text-color-child-active-hover);
 `, [b("a", "color: var(--n-item-text-color-child-active-hover);"), p("extra", "color: var(--n-item-text-color-child-active-hover);")])])]), y("selected", [T(null, [b("&::before", "background-color: var(--n-item-color-active-hover);")])]), T(null, pe)]), p("icon", `
 grid-area: icon;
 ...
 overflow: hidden;
 padding: 0;
 `, [Te({ duration: ".2s" })])]), g("menu-item-group", [g("menu-item-group-title", `
 margin-top: 6px;
 color: var(--n-group-text-color);
 cursor: default;
 font-size: .93em;
...
function re(e) {
  const r = E(B), { props: n, mergedCollapsedRef: s } = r, c = E(xe, null), d = E(ne, null), m = C(() => n.mode === "horizontal"), x = C(() => m.value ? n.dropdownPlacement : "tmNodes" in e ? "right-start" : "right"), u = C(() => {
    ...
    return m.value || !P || !s.value ? D : (A === void 0 ? w : A) + S + D - (v + S) / 2;
  });
...
const ie = { internalKey: { type: [String, Number], required: true }, root: Boolean, isGroup: Boolean, level: { type: Number, required: true }, title: [String, Function], extra: [String, Function] }, lo = k({ name: "MenuDivider", setup() {
  const e = E(B), { mergedClsPrefixRef: r, isHorizontalRef: n } = e;
  ...
  const { mergedClsPrefixRef: c, props: d } = E(B);
  return function() {
...
function le(e, r) {
  ...
  return e.children ? e.isGroup ? a(uo, Y(u, so, { tmNode: e, tmNodes: e.children, key: d })) : a(oe, Y(u, mo, { key: d, rawNodes: n[r.childrenField], tmNodes: e.children, tmNode: e })) : a(co, Y(u, ao, { key: d, tmNode: e }));
}
const ye = Object.assign(Object.assign({}, ie), { rawNodes: { type: Array, default: () => [] }, tmNodes: { type: Array, default: () => [] }, tmNode: { type: Object, required: true }, disabled: Boolean, icon: Function, onClick: Function, domId: String, virtualChildActive: { type: Boolean, default: void 0 }, isEllipsisPlaceholder: Boolean }), mo = te(ye), oe = k({ name: "Submenu", props: ye, setup(e) {
  ...
  return { menuProps: c, mergedTheme: m, doSelect: n.doSelect, inverted: n.invertedRef, isHorizontal: n.isHorizontalRef, mergedClsPrefix: n.mergedClsPrefixRef, maxIconSize: r.maxIconSize, activeIconSize: r.activeIconSize, iconMarginRight: r.iconMarginRight, dropdownPlacement: r.dropdownPlacement, dropdownShow: u, paddingLeft: r.paddingLeft, mergedDisabled: x, mergedValue: n.mergedValueRef, childActive: X(() => {
    var v;
  ...
  const { mergedClsPrefix: r, menuProps: { renderIcon: n, renderLabel: s } } = this, c = () => {
    const { isHorizontal: m, paddingLeft: x, collapsed: u, mergedDisabled: f, maxIconSize: R, activeIconSize: I, title: v, childActive: w, icon: A, handleClick: S, menuProps: { nodeProps: P }, dropdownShow: _, iconMarginRight: q, tmNode: K, mergedClsPrefix: j, isEllipsisPlaceholder: W, extra: $ } = this, N = P == null ? void 0 : P(K.rawNode);
    return a("div", Object.assign({}, N, { class: [`${j}-menu-item`, N == null ? void 0 : N.class], role: "menuitem" }), a(be, { tmNode: K, paddingLeft: x, collapsed: u, disabled: f, iconMarginRight: q, maxIconSize: R, activeIconSize: I, title: v, extra: $, showArrow: !m, childActive: w, clsPrefix: j, icon: A, hover: _, onClick: S, isEllipsisPlaceholder: W }));
  }, d = () => a(Oe, null, { default: () => {
    const { tmNodes: m, collapsed: x } = this;
    return x ? null : a("div", { class: `${r}-submenu-children`, role: "menu" }, m.map((u) => le(u, this.menuProps)));
  } });
  return this.root ? a(eo, Object.assign({ size: "large", trigger: "hover" }, (e = this.menuProps) === null || e === void 0 ? void 0 : e.dropdownProps, { themeOverrides: this.mergedTheme.peerOverrides.Dropdown, theme: this.mergedTheme.peers.Dropdown, builtinThemeOverrides: { fontSizeLarge: "14px", optionIconSizeLarge: "18px" }, value: this.mergedValue, disabled: !this.dropdownEnabled, placement: this.dropdownPlacement, keyField: this.menuProps.keyField, labelField: this.menuProps.labelField, childrenField: this.menuProps.childrenField, onUpdateShow: this.handlePopoverShowChange, options: this.rawNodes, onSelect: this.doSelect, inverted: this.inverted, renderIcon: n, renderLabel: s }), { default: () => a("div", { class: `${r}-submenu`, role: "menu", "aria-expanded": !this.collapsed, id: this.domId }, c(), this.isHorizontal ? null : d()) }) : a("div", { class: `${r}-submenu`, role: "menu", "aria-expanded": !this.collapsed, id: this.domId }, c(), d());
  ...
  const { mergedClsPrefixRef: r, inlineThemeDisabled: n } = Le(e), s = ge("Menu", "-menu", io, Ve, e, r), c = E(ro, null), d = C(() => {
    var i;
    const { collapsed: h } = e;
  ...
  const A = to(e, ["expandedNames", "expandedKeys"]), S = he(A, v), P = C(() => m.value.treeNodes), _ = C(() => m.value.getPath(I.value).keyPath);
  U(B, { props: e, mergedCollapsedRef: d, mergedThemeRef: s, mergedValueRef: I, mergedExpandedKeysRef: S, activePathRef: _, mergedClsPrefixRef: r, isHorizontalRef: C(() => e.mode === "horizontal"), invertedRef: ue(e, "inverted"), doSelect: q, toggleExpand: j });
  function q(i, h) {
  ...
  }), N = n ? Be("menu", C(() => e.inverted ? "a" : "b"), $, e) : void 0, J = je(), ae = F(null), Ie = F(null);
  let ce = true;
  const de = () => {
    var i;
  ...
  function He() {
    var i;
    if (V.value === -1) return a(oe, { root: true, level: 0, key: "__ellpisisGroupPlaceholder__", internalKey: "__ellpisisGroupPlaceholder__", title: "\xB7\xB7\xB7", tmNode: Pe.value, domId: J, isEllipsisPlaceholder: true });
    const h = Ae.value.treeNodes[0], o = _.value, l = !!(!((i = h.children) === null || i === void 0) && i.some((z) => o.includes(z.key)));
    return a(oe, { level: 0, root: true, key: "__ellpisisGroup__", internalKey: "__ellpisisGroup__", title: "\xB7\xB7\xB7", virtualChildActive: l, tmNode: h, domId: J, rawNodes: h.rawNode.children || [], tmNodes: h.children || [], isEllipsisPlaceholder: true });
  }
  return { mergedClsPrefix: r, controlledExpandedKeys: A, uncontrolledExpanededKeys: v, mergedExpandedKeys: S, uncontrolledValue: f, mergedValue: I, activePath: _, tmNodes: P, mergedTheme: s, mergedCollapsed: d, cssVars: n ? void 0 : $, themeClass: N == null ? void 0 : N.themeClass, overflowRef: ae, counterRef: Ie, updateCounter: () => {
  ...
  s == null ? void 0 : s();
  const c = () => this.tmNodes.map((u) => le(u, this.$props)), m = r === "horizontal" && this.responsive, x = () => a("div", $e(this.$attrs, { role: r === "horizontal" ? "menubar" : "menu", class: [`${e}-menu`, n, `${e}-menu--${r}`, m && `${e}-menu--responsive`, this.mergedCollapsed && `${e}-menu--collapsed`], style: this.cssVars }), m ? a(oo, { ref: "overflowRef", onUpdateOverflow: this.onUpdateOverflow, getCounter: this.getCounter, onUpdateCount: this.onUpdateCount, updateCounter: this.updateCounter, style: { width: "100%", display: "flex", overflow: "hidden" } }, { default: c, counter: this.renderCounter }) : c());
  return m ? a(Ke, { onResize: this.onResize }, { default: x }) : x();
} }), fo = { class: "flex h-screen bg-slate-900 text-slate-200 overflow-hidden" }, go = { class: "w-52 flex flex-col bg-slate-800 border-r border-slate-700/60 shrink-0" }, xo = { class: "px-4 py-3 border-t border-slate-700/60 flex items-center justify-between" }, bo = { class: "text-xs text-slate-500" }, Co = { class: "flex-1 overflow-auto" }, zo = { class: "p-6" }, No = k({ __name: "default", setup(e) {
  const r = De(), n = We(), s = Je(), c = [{ key: "/dashboard", label: "Dashboard", icon: () => a("span", { class: "i-carbon-dashboard text-base" }) }, { key: "/keys", label: "API Keys", icon: () => a("span", { class: "i-carbon-api text-base" }) }, { key: "/backends", label: "Backends", icon: () => a("span", { class: "i-carbon-server-dns text-base" }) }, { key: "/mappings", label: "Model Maps", icon: () => a("span", { class: "i-carbon-arrows-horizontal text-base" }) }, { key: "/usage", label: "Usage", icon: () => a("span", { class: "i-carbon-chart-bar text-base" }) }, { key: "/flags", label: "Flags", icon: () => a("span", { class: "i-carbon-toggle-on text-base" }) }], d = C(() => s.path);
  function m(u) {
    n.push(u);
  }
  function x() {
  ...
  return (u, f) => {
    const R = po, I = qe, v = Ye("RouterView");
    return Ze(), Ue("div", fo, [H("aside", go, [f[2] || (f[2] = H("div", { class: "px-5 py-4 border-b border-slate-700/60" }, [H("span", { class: "text-indigo-400 font-semibold text-[15px]" }, "one-router"), H("span", { class: "ml-2 text-[11px] text-slate-400 bg-slate-700 px-1.5 py-0.5 rounded" }, "admin")], -1)), Z(R, { options: c, value: ve(d), indent: 16, class: "flex-1 pt-2", "onUpdate:value": m }, null, 8, ["value"]), H("div", xo, [H("span", bo, "v" + Ge(ve(r).version || "\u2014"), 1), Z(I, { size: "tiny", quaternary: "", onClick: x }, { icon: me(() => [...f[0] || (f[0] = [H("span", { class: "i-carbon-logout" }, null, -1)])]), default: me(() => [f[1] || (f[1] = Qe(" Sign out ", -1))]), _: 1 })])]), H("main", Co, [H("div", zo, [Z(v)])])]);
  };
} });
export {
  No as default
