import { f as n, h as o, d as C, j as a, L as r, k as S, l as v, aN as R, ab as $, m as T, a as w } from "./index-DicalUKt.js";
const E = n("statistic", [o("label", `
 ...
 `, [n("icon", { verticalAlign: "-0.125em" })])])]), N = Object.assign(Object.assign({}, v.props), { tabularNums: Boolean, label: String, value: [String, Number] }), j = C({ name: "Statistic", props: N, slots: Object, setup(s) {
  const { mergedClsPrefixRef: t, inlineThemeDisabled: i, mergedRtlRef: c } = S(s), u = v("Statistic", "-statistic", E, R, s, t), f = $("Statistic", c, t), e = w(() => {
    const { self: { labelFontWeight: b, valueFontSize: d, valueFontWeight: x, valuePrefixTextColor: m, labelTextColor: h, valueSuffixTextColor: g, valueTextColor: p, labelFontSize: z }, common: { cubicBezierEaseInOut: _ } } = u.value;
    return { "--n-bezier": _, "--n-label-font-size": z, "--n-label-font-weight": b, "--n-label-text-color": h, "--n-value-font-weight": x, "--n-value-font-size": d, "--n-value-prefix-text-color": m, "--n-value-suffix-text-color": g, "--n-value-text-color": p };
