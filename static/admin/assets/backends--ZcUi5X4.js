import { u as Q } from "./backends-CLLt8N6j.js";
import { u as X } from "./useApi-ViaiVG_-.js";
import { _ as ee, a as te } from "./InputNumber-W3KW47sQ.js";
import { _ as ne } from "./FormItem-CcawL2pJ.js";
import { i as se, c as B, a as le, b as ae, e as P, f as oe, g as G, h as ie, d as W, j as C, k as re, o as Y, w as V, l as Z, m as ue, r as k, t as K, n as q, p as x, q as n, s as j, v as _, x as F, y, z as E, A as J, B as O, C as ce, D as de } from "./index-HnuybbhN.js";
import { _ as me, a as fe, N as U } from "./DataTable-r4E-uZoH.js";
import { B as L, _ as he } from "./Button-DSNNFXd2.js";
...
const pe = { common: ae, self: ge }, ye = P([oe("code", `
 ...
 text-decoration: underline;
  ...
  const { internalNoHighlight: a } = s, { mergedClsPrefixRef: p, inlineThemeDisabled: u } = re(), m = k(null), f = a ? { value: void 0 } : ve(s), N = (t, l, h) => {
    const { value: g } = f;
  ...
  }), c = u ? ue("code", B(() => `${s.internalFontSize || "a"}`), $, s) : void 0;
...
`);
  ...
  return Y(N), (t, l) => {
    const h = fe;
    return j(), E("div", null, [y("div", Oe, [l[3] || (l[3] = y("h1", { class: "text-xl font-semibold text-slate-100" }, "Backends", -1)), _(n(L), { type: "primary", onClick: v }, { icon: x(() => [...l[1] || (l[1] = [y("span", { class: "i-carbon-add" }, null, -1)])]), default: x(() => [l[2] || (l[2] = O(" Add Backend ", -1))]), _: 1 })]), _(h, { columns: c, data: n(p), loading: n(u), pagination: false, size: "small" }, null, 8, ["data", "loading"]), _(Ee, { show: n(m), "onUpdate:show": l[0] || (l[0] = (g) => de(m) ? m.value = g : null), existing: n(f), onSaved: N }, null, 8, ["show", "existing"])]);
  };
} });
export {
  Ve as default
